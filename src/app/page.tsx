...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#080a09] text-white">
      ...
      <main>
        <section className="relative overflow-hidden border-b border-white/10 px-4 pb-24 pt-32 md:pt-40">
          ...
          <div className="relative mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
            <div className="text-center lg:text-left">
              <div className="mx-auto mb-7 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-sm font-medium text-white/65 lg:mx-0">
                <span className="h-2 w-2 rounded-full bg-primary shadow-[0_0_18px_rgba(4,118,59,0.85)]" />
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/58 lg:mx-0">
              ...
              <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row lg:justify-start">
                <Link href="/register" className="inline-flex h-14 items-center gap-3 rounded-full bg-white px-7 text-base font-bold text-[#111411] shadow-[0_18px_50px_rgba(255,255,255,0.16)] transition hover:bg-accent">
                  Get Started
                  <ArrowRight className="h-5 w-5" />
                </Link>
                <Link href="/login" className="inline-flex h-14 items-center rounded-full border border-white/12 px-7 text-base font-semibold text-white/75 transition hover:border-white/25 hover:text-white">
                  Launch Dashboard
                </Link>
              </div>
            ...
            <div className="dark-glass relative overflow-hidden rounded-[2rem] p-4">
              <div className="rounded-[1.5rem] border border-white/10 bg-[#f7f8f4] p-4 text-[#20241f] shadow-2xl">
        ...
        <section className="border-b border-white/10 px-4 py-12">
          <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-6 text-white/35">
            {partners.map((partner) => (
              <div key={partner} className="flex items-center gap-3 text-lg font-bold">
                <span className="grid h-9 w-9 place-items-center rounded-full bg-white/[0.06] text-sm">{partner[0]}</span>
                {partner}
              </div>
            ))}
          </div>
        ...
        <section id="features" className="px-4 py-24">
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="text-4xl font-black md:text-5xl">Everything needed for clean tax operations</h2>
              <p className="mt-4 text-lg leading-8 text-white/50">From onboarding to receipts, every surface is designed for repeated compliance work.</p>
            </div>

            <div className="mt-14 grid gap-5 md:grid-cols-2">
              {features.map((feature) => (
                <article key={feature.title} className="dark-glass rounded-[1.5rem] p-8">
                  <div className="mb-8 grid h-12 w-12 place-items-center rounded-2xl bg-white/8 text-primary">
                    <feature.icon className="h-6 w-6" />
                  </div>
                  <h3 className="text-2xl font-black">{feature.title}</h3>
                  <p className="mt-4 leading-7 text-white/50">{feature.text}</p>
                </article>
              ))}
            </div>
          </div>
        ...
        <section id="how-it-works" className="border-y border-white/10 px-4 py-24">
          <div className="mx-auto max-w-6xl">
            <h2 className="text-center text-4xl font-black md:text-5xl">A simple compliance flow</h2>
            <div className="mt-12 grid gap-5 md:grid-cols-3">
              {steps.map(([number, title, text]) => (
                <article key={number} className="rounded-[1.5rem] border border-white/10 bg-white/[0.035] p-7">
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-3">
              {[
                ...
                <article key={name as string} className={`rounded-[1.5rem] border p-8 ${index === 1 ? "border-white/25 bg-white/[0.08]" : "border-white/10 bg-white/[0.035]"}`}>
        ...
        <section className="border-t border-white/10 px-4 py-24">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
              ...
              <Link href="/dashboard" className="inline-flex h-14 items-center justify-center gap-3 rounded-full border border-white/12 px-7 font-bold text-white/70">
                View Dashboard
              </Link>
            </div>
          </div>
      ...
      <footer id="faq" className="border-t border-white/10 px-4 py-14">
        <div className="mx-auto grid max-w-6xl gap-8 text-white/45 md:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr]">
          <div>
            <div className="mb-5 flex items-center gap-3 text-white">
              <span className="grid h-10 w-10 place-items-center rounded-full bg-white text-sm font-black text-primary">T</span>
          ...
          {[
            ...
            <div key={heading}>
              <h3 className="mb-5 font-bold text-white">{heading}</h3>
